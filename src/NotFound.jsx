  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center  bg-white">
      ...
      <div className="text-center max-w-md mx-4 relative">
        ...
        <Link
          to={"/"}
          className="inline-block rounded-full bg-gradient-to-r from-purple-600 to-yellow-500 px-8 py-3 text-white font-bold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 hover:from-purple-700 hover:to-yellow-600"
        >
          {t.backHome.texte}
        </Link>
      </div>
