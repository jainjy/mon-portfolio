    ...
    <>
      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div
            className="absolute top-20 left-10 w-20 h-20 border border-purple-400/40 dark:border-purple-300/30 rotate-45 animate-float"
          ></div>
          <div
            className="absolute top-40 right-20 w-16 h-16 bg-yellow-400/30 dark:bg-yellow-300/20 rounded-full animate-float-delayed"
          ></div>
          <div
            className="absolute bottom-40 left-20 w-12 h-12 bg-purple-500/30 dark:bg-purple-400/20 transform rotate-45 animate-pulse"
          ></div>
          <div
            className="absolute top-1/3 right-1/4 w-8 h-8 bg-purple-600/40 dark:bg-purple-500/30 rounded-full animate-bounce"
          ></div>
        </div>
            ...
            <div className="space-y-8">
                ...
                {[
                  {
                    ...
                    color: "group-hover:text-gray-300 dark:group-hover:text-purple-300",
                    bg: "group-hover:bg-gray-600/20 dark:group-hover:bg-purple-600/30",
                  },
                  {
                    icon: FaLinkedin,
                    href: "https://linkedin.com/in/ramamonjisoa-andrianina",
                    color: "group-hover:text-blue-400 dark:group-hover:text-yellow-300",
              ...
              >
                ...
                <div className="space-y-3 text-purple-200 dark:text-purple-100">
                  <a className="flex items-center gap-2 hover:text-yellow-300 dark:hover:text-yellow-200 transition-colors" href='mailto:ramamonjisoandrianina@gmail.com'>
                    <HiOutlineMail className="text-purple-400 dark:text-yellow-400 text-lg" />
                    ramamonjisoandrianina@gmail.com
                  </a>
                  <a className="flex items-center gap-2 hover:text-yellow-300 dark:hover:text-yellow-200 transition-colors" href='tel:+261 34 20 219 88'>
