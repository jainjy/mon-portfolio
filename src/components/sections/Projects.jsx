...
import { FaGithub, FaCode, FaArrowDown, FaTimes, FaEye } from "react-icons/fa";
        ...
        {visibleCount < projects.length && (
          <div className="mt-12 flex justify-center">
            <button
              ...
              data-aos="fade-up"
              className="group relative flex items-center gap-3 px-8 py-3 rounded-2xl font-semibold text-yellow-900 dark:text-yellow-100 bg-gradient-to-r from-yellow-400 to-yellow-500 dark:from-purple-800 dark:via-purple-900 dark:to-purple-400 shadow-lg hover:shadow-2xl border border-yellow-300 dark:border-purple-600 overflow-hidden transition-all duration-300 hover:scale-105 active:scale-95"
            >
