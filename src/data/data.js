...
const projects = {
  fr: [
    ...
    {
      title: "Olimmo - Gestion immobilière",
      description:
        "Application web dédiée au suivi immobilier, centralisant la gestion des biens, des propriétaires, des locataires et des contrats de location dans une interface claire et structurée.",
      gradient: "from-cyan-500 via-blue-500 to-indigo-600",
      tech: ["React", "Node.js", "Express", "PostgreSQL"],
      image: "/images/olimmo.png",
      github: "https://github.com/jainjy",
    },
    {
      title: "Oliplus - Services immobiliers",
      description:
        "Plateforme de mise en relation à La Réunion connectant prestataires, clients et agences immobilières, avec recherche avancée assistée par IA et carte interactive.",
      gradient: "from-emerald-500 via-teal-500 to-cyan-600",
      tech: ["React", "Node.js", "Express", "PostgreSQL"],
      image: "/images/oliplus.png",
      github: "https://github.com/jainjy",
    },
    {
      title: "alefaExpress - Livraison intelligente",
      description:
        "Solution mobile et web pour organiser les livraisons, suivre les commandes sur carte, sécuriser les retraits par QR code et gérer les espaces client, livreur, collecteur et administrateur.",
  ...
  en: [
    ...
    {
      title: "Olimmo - Real Estate Management",
      description:
        "Web application for real estate operations, bringing property, owner, tenant, and lease contract management into a clear and organized workspace.",
      gradient: "from-cyan-500 via-blue-500 to-indigo-600",
      tech: ["React", "Node.js", "Express", "PostgreSQL"],
      image: "/images/olimmo.png",
      github: "https://github.com/jainjy",
    ...
    {
      title: "Oliplus - Real Estate Services",
      description:
        "Service marketplace for La Réunion connecting providers, clients, and real estate agencies, with AI-powered advanced search and an interactive map.",
      gradient: "from-emerald-500 via-teal-500 to-cyan-600",
      tech: ["React", "Node.js", "Express", "PostgreSQL"],
      image: "/images/oliplus.png",
      github: "https://github.com/jainjy",
    ...
    {
      title: "alefaExpress - Smart Delivery",
      description:
        "Mobile and web delivery solution for order tracking, live map monitoring, QR code pickup security, and dedicated workspaces for clients, drivers, collectors, and administrators.",
      gradient: "from-orange-500 via-red-500 to-pink-600",
      tech: ["React", "React Native", "Node.js", "MySQL"],
      image: "/images/livraison.jpg",
      github: "https://github.com/jainjy",
