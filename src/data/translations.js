export const translations = {
  fr: {
    ...
    skills: {
      ...
      subtitle: "Technologies que je maîtrise avec passion",
      categories: {
        programming: "Langages de programmation",
        frontend: "Frameworks Frontend",
        backend: "Frameworks Backend",
        api: "API & Services Web",
    ...
    projects: {
      title: "Mes projets",
      subtitle: "Découvrez mes réalisations les plus récentes",
      seeMore: "Voir plus",
    ...
    contact: {
      ...
      discussion: {
        ...
        description:
          "Vous avez une idée géniale ? Un projet ambitieux ? Je serais ravi de discuter avec vous et de voir comment nous pouvons créer quelque chose d'exceptionnel ensemble.",
    ...
    experience: {
      title: "Mon Parcours",
      subtitle: "Mes expériences professionnelles et contributions",
      status: {
        current: "Actuel",
        remote: "Télétravail",
        onsite: "Sur site",
      ...
      responsibilities: "Responsabilités & Réalisations",
      technologies: "Technologies utilisées",
      hoverInfo: "Cliquez pour plus d'infos",
      expandCard: "Développer",
    },
  },
  en: {
    nav: {
    ...
    hero: {
      ...
      description:
        "I transform your ideas into digital reality with creativity and innovation",
      contact: "Contact Me",
      download: "My CV",
    },
    about: {
      ...
      passion: {
        ...
        description:
          "Passionate web developer with a strong background in software engineering. I enjoy solving complex problems and creating innovative applications that improve users' lives.",
      },
      innovation: {
        title: "Innovation & Creativity",
        description:
          "Each project is a new adventure. I strive to stay at the forefront of technology and bring a creative approach to each challenge, as demonstrated by my numerous personal projects.",
      },
    ...
    skills: {
      title: "My Skills",
      subtitle: "Technologies I master with passion",
      categories: {
    ...
    projects: {
      title: "My Projects",
      subtitle: "Discover my latest achievements",
      seeMore: "See More",
    ...
    contact: {
      ...
      discussion: {
        ...
        description:
          "Have a brilliant idea? An ambitious project? I would love to discuss with you and see how we can create something exceptional together.",
    ...
    footer: {
      description:
        "Passionate Web Developer creating innovative applications with creativity and technical expertise.",
    ...
    experience: {
      title: "My Journey",
      subtitle: "My professional experiences and contributions",
      status: {
        current: "Current",
        remote: "Remote",
        onsite: "On site",
